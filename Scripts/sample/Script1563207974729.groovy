...
WebUI.click(findTestObject('Store Locator/Results total list'))

WebUI.setText(findTestObject('Store Locator/Search input'), '49418')

WebUI.click(findTestObject('Store Locator/Results list after'))

WebUI.click(findTestObject('Store Locator/Distance filter'))

WebUI.click(findTestObject('Store Locator/Filter'))

WebUI.click(findTestObject('Store Locator/button_Filter'))

WebUI.click(findTestObject('Store Locator/Label - until 9pm'))

WebUI.click(findTestObject('Store Locator/Results list after filter'))

WebUI.click(findTestObject('Store Locator/Clear filter'))

WebUI.click(findTestObject('Store Locator/Next button'))

WebUI.click(findTestObject('Store Locator/Prev - button'))

WebUI.selectOptionByValue(findTestObject('Store Locator/select dropdown'), '2', true)

WebUI.openBrowser('')

WebUI.navigateToUrl('https://charlotterusse.com/')

WebUI.click(findTestObject('Object Repository/sample/Store Locator/Footer/a_Contact Us'))

WebUI.click(findTestObject('Object Repository/sample/Store Locator/Footer/a_Track Order'))

WebUI.click(findTestObject('Page_Account  Charlotte Russe/a_Shipping Info'))

WebUI.click(findTestObject('Object Repository/sample/Store Locator/Footer/a_Return Policy'))

WebUI.click(findTestObject('Object Repository/sample/Store Locator/Footer/a_About Us'))

WebUI.click(findTestObject('Page_About Us  Charlotte Russe/a_Careers'))

WebUI.click(findTestObject('Object Repository/sample/Store Locator/Footer/a_Terms  Conditions'))

WebUI.click(findTestObject('Object Repository/sample/Store Locator/Footer/a_Privacy Policy'))

WebUI.click(findTestObject('Object Repository/sample/Store Locator/Footer/a_Social Media Policy'))

WebUI.click(findTestObject('Object Repository/sample/Store Locator/Footer/a_FAQs'))

WebUI.click(findTestObject('Object Repository/sample/Store Locator/Footer/a_Size Chart'))

WebUI.click(findTestObject('Object Repository/sample/Store Locator/Footer/a_Find a Store'))

WebUI.click(findTestObject('Object Repository/sample/Store Locator/Footer/Facebook'))

WebUI.click(findTestObject('Object Repository/sample/Store Locator/Footer/twitter'))

WebUI.click(findTestObject('Object Repository/sample/Store Locator/Footer/Instagram'))

WebUI.click(findTestObject('Object Repository/sample/Store Locator/Footer/Pintrest'))

WebUI.click(findTestObject('Object Repository/sample/Store Locator/Footer/youtube'))

WebUI.setText(findTestObject('Object Repository/sample/Store Locator/Footer/Input'), 'suman@gmail.com')

WebUI.click(findTestObject('Object Repository/sample/Store Locator/Footer/button_Sign Up'))

WebUI.click(findTestObject('Object Repository/sample/Store Locator/Footer/div_Thank you for subscribing'))

WebUI.click(findTestObject('Object Repository/sample/Store Locator/Footer/Contact us'))

WebUI.click(findTestObject('Object Repository/sample/Store Locator/Footer/Track package'))

WebUI.click(findTestObject('Object Repository/sample/Store Locator/Footer/Store locator'))
