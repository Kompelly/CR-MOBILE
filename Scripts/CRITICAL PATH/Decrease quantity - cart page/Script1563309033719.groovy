...
WebUI.scrollToElement(findTestObject('CR-DESKTOP/Customer info page/cart page link'), 0)
...
WebUI.setText(findTestObject('CR-DESKTOP/Cart page/input_Quantity_updates'), '3')
...
WebUI.setText(findTestObject('CR-DESKTOP/Cart page/input_Quantity_updates'), '2')
