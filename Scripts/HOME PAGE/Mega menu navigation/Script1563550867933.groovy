...
WebUI.click(findTestObject('CR-DESKTOP/Mega menu/Shoes - New shoes'))
...
WebUI.click(findTestObject('CR-DESKTOP/Mega menu/Clothes - Tops'))
...
WebUI.click(findTestObject('CR-DESKTOP/Mega menu/Plus -tops'))
